...
<?php
    ...
    if(strlen($query) >= $min_length){
     ...
     if ($results['recimg'] == "no") {
                    ...
                    ?>
                 <div class='h1' onclick="location.href='post.php?pid=<?php echo $results['id'];?>'"  style='background-image: url(img/<?php echo $results['recimg'];?>);'><a href="post.php?pid=<?php echo $results['id'];?>"></a>
     <div class='h2'>
